    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        switch (uiState) {
            case STATE_INITIALIZED:
                ...
                mBinding.detail.setText( (String) null );
                break;
            case STATE_CODE_SENT:
                ...
                mBinding.detail.setText( String.valueOf( R.string.status_code_sent ) );
                break;
            case STATE_VERIFY_FAILED:
                ...
                mBinding.detail.setText( String.valueOf( R.string.status_verification_failed ) );
                break;
            case STATE_VERIFY_SUCCESS:
                ...
                disableViews(mBinding.buttonStartVerification, mBinding.buttonVerifyPhone, mBinding.buttonResend, mBinding.fieldPhoneNumber,
                        mBinding.fieldVerificationCode);
                mBinding.detail.setText( String.valueOf( R.string.status_verification_succeeded ) );
            ...
            case STATE_SIGNIN_FAILED:
                ...
                mBinding.detail.setText( String.valueOf( R.string.status_sign_in_failed ) );
                break;
        ...
        if (user == null) {
            ...
            mBinding.status.setText( String.valueOf( R.string.signed_out ) );
        } else {
            // Signed in
            ...
            mBinding.status.setText( String.valueOf( R.string.signed_in ) );
